...
import 'med5_model.dart';
export 'med5_model.dart';

class Med5Widget extends StatefulWidget {
  const Med5Widget({super.key});

  static String routeName = 'med5';
  static String routePath = '/med5';

  @override
  State<Med5Widget> createState() => _Med5WidgetState();
}

class _Med5WidgetState extends State<Med5Widget> with TickerProviderStateMixin {
  late Med5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Med5Model());
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              20.0, 20.0, 0.0, 0.0),
                          child: Text(
                            'Vuelve aquí, ahora. Meditacion para \ncultivar atención plena y presencia.',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.inter(
            ...
            FFButtonWidget(
              onPressed: () async {
                context.pushNamed(Music5Widget.routeName);
              },
