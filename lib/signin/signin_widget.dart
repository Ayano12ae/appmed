        ...
        body: Column(
          ...
          children: [
            Container(
              ...
              height: MediaQuery.sizeOf(context).height * 0.409,
              decoration: BoxDecoration(
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: Image.asset(
                    'assets/images/Group_6800.png',
                  ).image,
                ),
              ),
              child: Column(
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(WelcomesleepWidget.routeName);
                          },
                          child: Container(
                            width: 48.0,
                            height: 48.0,
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                if (_model.logTextController.text.isEmpty) {
                ...
                await authManager.updateEmail(
                  email: _model.logTextController.text,
                  context: context,
                );
                safeSetState(() {});
              },
              child: Text(
                'O Inicia Sesión con tu Gmail',
            ...
            Container(
              ...
              child: TextFormField(
                controller: _model.logTextController,
                ...
                validator:
                    _model.logTextControllerValidator.asValidator(context),
              ),
            ),
            Padding(
            ...
            FFButtonWidget(
              onPressed: () async {
                ...
                context.goNamedAuth(Menu1Widget.routeName, context.mounted);
              },
              text: 'Inicia Sesión',
